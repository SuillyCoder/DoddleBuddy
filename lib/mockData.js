    ...
    if (userSnap.exists()) {
      ...
      const updatedData = {
        ...
        referenceGalleryPics: [
          ...
          ...(guestGallery ? JSON.parse(guestGallery) : []),
        ],
        promptList: [
        ...
        favoritesGalleryPics: [
          ...(existingData.favoritesGalleryPics || []),
      ...
      localStorage.removeItem('guest_gallery');
